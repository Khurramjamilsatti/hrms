  ...
  <div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
      ...
      <div class="flex flex-wrap items-center gap-2">
        <button
          v-if="can('training.manage') || can('training.create')"
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
      <div v-for="enrollment in enrollments" :key="enrollment.id" 
        ...
        <div class="p-4 border-t border-gray-200 flex items-center gap-2">
          ...
          <button v-if="can('training.manage') && !enrollment.certificate_issued" @click="confirmDelete(enrollment)" class="inline-flex items-center justify-center px-3 py-2 text-sm font-medium text-white bg-red-600 hover:bg-red-700 rounded-lg transition-colors">
