      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              <th v-if="canManageOthers" class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Employee</th>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="ts in timesheets" :key="ts.id" class="hover:bg-gray-50">
              <td v-if="canManageOthers" class="px-6 py-4 whitespace-nowrap">
