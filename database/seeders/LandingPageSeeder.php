    ...
    public function run(): void
    {
        ...
        $faqs = [
            ...
            [
                ...
                'answer' => 'Yes. The employee self-service portal is fully responsive and works on any mobile browser, so employees can check attendance, apply for leave, and view payslips from their phone without installing anything extra.',
                'category' => 'Mobile',
                'sort_order' => 8,
            ],
        ];
