<template>
  <div class="relative" ref="dropdown">
    <div
      ...
      class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white transition-all"
      :class="disabled
        ? 'bg-gray-100 cursor-not-allowed opacity-80'
        : 'cursor-pointer hover:border-gray-400 focus-within:ring-2 focus-within:ring-gray-900 focus-within:border-transparent'"
    >
    ...
    <!-- Dropdown -->
    <div v-if="isOpen && !disabled" class="absolute z-50 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-80 overflow-hidden">
      <!-- Search Input -->
      ...
      <div class="overflow-y-auto max-h-60">
        ...
        <div
          ...
          :class="{ 'bg-blue-50 text-blue-700 font-medium': String(modelValue) === String(option.value) }"
        >
          <div class="flex items-center">
            <svg v-if="String(modelValue) === String(option.value)" class="w-4 h-4 mr-2 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
